...
class MiniCourt():
    ...
    def get_mini_court_coordinates(self,
        ...
        #convert the distance from keypoint in pixels to meters
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes,ball_boxes,original_court_keypoints):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            for player_id,bbox in player_bbox.items():
                ...
                #get the closest court keypoint to the foot position in pixels
                closest_keypoint_index = get_closest_keypoints_index(foot_position, original_court_keypoints, [0,2,12,13])
                closest_keypoint = (original_court_keypoints[closest_keypoint_index*2], original_court_keypoints[closest_keypoint_index*2 +1])

                #get player's height in pixels
                ...
                if closest_player_id_to_ball == player_id:
                    #get the closest court keypoint to the foot position in pixels
                    closest_keypoint_index = get_closest_keypoints_index(ball_position, original_court_keypoints, [0,2,12,13])
                    closest_keypoint = (original_court_keypoints[closest_keypoint_index*2], original_court_keypoints[closest_keypoint_index*2 +1])
